export const authors = {
  ...
  mkpoli: {
    ...
    repository:
      "https://github.com/mkpoli/VTuber-Styled-Logos/blob/main/LICENSE",
  },
  "fuma-nama": {
    name: "fuma-nama",
  ...
  disphing: {
    ...
    license: {},
    repository:
      "https://drive.google.com/drive/folders/1Hy1_pAWx95QTv1nZFKUl96GImq4iKdf8",
  },
  aikoyori: {
    name: "aikoyori",
  ...
  hvpexe: {
    ...
    repository:
      "https://github.com/hvpexe/ProgrammingVTuberLogos-VisualStudio/",
    license: {
      label: "CC-BY-NC-SA-4.0",
