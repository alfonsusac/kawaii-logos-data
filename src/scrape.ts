...
// //  - handleName: from defined / github username
// //  - pfp: from defined / github avatar
// //  - link: from defined githuv / twitter / bluesky
// //  - license: from defined
// //  - repository: from defined
// //  - groups: processed from file paths
// //     - all groups should be included, even if they only have 1 file (or 0 files?)
// //     - group name should be preprocessed file path (e.g. "logos/tech/apple.png" -> "tech")
// //     - files should be preprocessed file paths (e.g. "logos/tech/apple.png" -> "apple.png")
// //     - object fit should be from config, default to "cover"
// //     - createdAt should be from git history, default to undefined if error retrieving or not found  
